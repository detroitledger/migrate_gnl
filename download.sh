...
# concatenate
cat $DESTDIR/grants*.csv | grep -v 'granter,granter_program,grantee,grantee_city,grantee_state,impact_area,impact_neighborhood,amount,year,length_years,data_source,notes' > $DESTDIR/allgrants-raw.csv
...
# add header row
echo 'id,granter,granter_program,grantee,grantee_city,grantee_state,impact_area,impact_neighborhood,amount,year,length_years,data_source,notes' > $DESTDIR/allgrants.csv
